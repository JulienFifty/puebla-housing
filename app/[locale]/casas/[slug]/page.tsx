              ...
              <div className="sticky top-24 bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                ...
                <div className="grid grid-cols-2 gap-2 mb-6">
                  <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <span className="text-xs font-medium text-gray-900 leading-tight">{tProperty('instantBooking')}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <span className="text-xs font-medium text-gray-900 leading-tight">{tProperty('bestPriceGuaranteed')}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <span className="text-xs font-medium text-gray-900 leading-tight">{tProperty('verifiedProperties')}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                    ...
                    <span className="text-xs font-medium text-gray-900 leading-tight">{tProperty('personalAssistance')}</span>
                  </div>

                  <div className="flex items-center gap-2 p-2 hover:bg-gray-50 rounded-lg transition-colors col-span-2">
                    <div className="w-6 h-6 bg-amber-100 rounded flex items-center justify-center flex-shrink-0">
                      <svg className="w-3.5 h-3.5 text-amber-600" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                    </div>
                    <span className="text-xs font-medium text-gray-900 leading-tight">{tProperty('reviewsCount')}</span>
                  </div>
                </div>
